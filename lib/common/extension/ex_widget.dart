...
extension ExWidget on Widget {
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              color: shadowColor ?? Colors.white38,
              // 阴影模糊半径
  ...
  // /// 内间距 全
  Widget vvPaddingAll(double val) => vvPadding(all: val);

  /// 内间距 下
  Widget vvPaddingBottom(double val) => vvPadding(bottom: val);

  /// 内间距 左
  Widget vvPaddingLeft(double val) => vvPadding(left: val);

  /// 内间距 右
  Widget vvPaddingRight(double val) => vvPadding(right: val);

  /// 内间距 上
  Widget vvPaddingTop(double val) => vvPadding(top: val);

  /// 内间距 横向
  Widget vvPaddingHorizontal(double val) => vvPadding(horizontal: val);

  /// 内间距 纵向
  Widget vvPaddingVertical(double val) => vvPadding(vertical: val);
